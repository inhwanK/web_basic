...
<body>
	...
	<form action="partUploadPro2" method="post" enctype="multipart/form-data">
		...
		<label for="partFile1">업로드 파일 1 : </label><input type="file" name="partFile1" id="partFile1"><br>
		<label for="partFile2">업로드 파일 2 : </label><input type="file" name="partFile2" id="partFile2"><br>
